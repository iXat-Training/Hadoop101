...
namespace com.ixat.avro.model
{
	...
	{
		public static Schema _SCHEMA = Avro.Schema.Parse("{\"type\":\"record\",\"name\":\"User\",\"namespace\":\"com.ixat.avro.model\",\"fields\":[{\"name" +
				"\":\"name\",\"type\":\"string\"},{\"name\":\"favorite_number\",\"type\":[\"int\",\"null\"]},{\"nam" +
				"e\":\"favorite_color\",\"type\":[\"string\",\"null\"]}]}");
